...
using System;
namespace Soenneker.Make.OpenApiClient.Scenarios.Item.Logs.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \scenarios\{scenarioId}\logs\{executionId}
    /// </summary>
    ...
    public partial class WithExecutionItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithExecutionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/scenarios/{scenarioId}/logs/{executionId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Make.OpenApiClient.Scenarios.Item.Logs.Item.WithExecutionItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithExecutionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/scenarios/{scenarioId}/logs/{executionId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Make.OpenApiClient.Scenarios.Item.Logs.Item.WithExecutionItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Make.OpenApiClient.Scenarios.Item.Logs.Item.WithExecutionItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
