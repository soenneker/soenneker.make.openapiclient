...
namespace Soenneker.Make.OpenApiClient.Users.Roles
{
    ...
    public partial class RolesRequestBuilder : BaseRequestBuilder
    {
        ...
        public RolesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/roles{?category*,cols%5B%5D*,excludeRole%5B%5D*,organizationId*,roleId*,teamId*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Make.OpenApiClient.Users.Roles.RolesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RolesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/roles{?category*,cols%5B%5D*,excludeRole%5B%5D*,organizationId*,roleId*,teamId*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
            ...
            public global::Soenneker.Make.OpenApiClient.Models.GetUsersRolesColsParameterItem[]? Cols { get; set; }
#nullable restore
#else
            [QueryParameter("cols%5B%5D")]
            public global::Soenneker.Make.OpenApiClient.Models.GetUsersRolesColsParameterItem[] Cols { get; set; }
