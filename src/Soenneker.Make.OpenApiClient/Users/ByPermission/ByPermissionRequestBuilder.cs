...
namespace Soenneker.Make.OpenApiClient.Users.ByPermission
{
    ...
    public partial class ByPermissionRequestBuilder : BaseRequestBuilder
    {
        ...
        public ByPermissionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/by-permission?permission={permission}&type={type}{&cols%5B%5D*,organizationId*,teamId*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Make.OpenApiClient.Users.ByPermission.ByPermissionRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ByPermissionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/by-permission?permission={permission}&type={type}{&cols%5B%5D*,organizationId*,teamId*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
            ...
            public global::Soenneker.Make.OpenApiClient.Models.GetUsersByPermissionColsParameterItem[]? Cols { get; set; }
#nullable restore
#else
            [QueryParameter("cols%5B%5D")]
            public global::Soenneker.Make.OpenApiClient.Models.GetUsersByPermissionColsParameterItem[] Cols { get; set; }
