...
using System;
namespace Soenneker.Make.OpenApiClient.Users.Item.UserTeamNotifications.Item.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \users\{userId}\user-team-notifications\{teamId}\{notificationId}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithNotificationItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Make.OpenApiClient.Users.Item.UserTeamNotifications.Item.Item.WithNotificationItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithNotificationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{userId}/user-team-notifications/{teamId}/{notificationId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Make.OpenApiClient.Users.Item.UserTeamNotifications.Item.Item.WithNotificationItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithNotificationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{userId}/user-team-notifications/{teamId}/{notificationId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Make.OpenApiClient.Users.Item.UserTeamNotifications.Item.Item.WithNotificationItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Make.OpenApiClient.Users.Item.UserTeamNotifications.Item.Item.WithNotificationItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
