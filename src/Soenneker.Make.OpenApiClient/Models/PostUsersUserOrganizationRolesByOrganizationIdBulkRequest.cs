...
namespace Soenneker.Make.OpenApiClient.Models
{
    ...
    public partial class PostUsersUserOrganizationRolesByOrganizationIdBulkRequest : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The IDs of the users whose organization role is changed, or who are removed from the organization. Between 1 and 100 users; duplicates are ignored.</summary>
...
#nullable restore
        ...
        /// </summary>
        public PostUsersUserOrganizationRolesByOrganizationIdBulkRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Make.OpenApiClient.Models.PostUsersUserOrganizationRolesByOrganizationIdBulkRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Make.OpenApiClient.Models.PostUsersUserOrganizationRolesByOrganizationIdBulkRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Make.OpenApiClient.Models.PostUsersUserOrganizationRolesByOrganizationIdBulkRequest();
        }
        /// <summary>
