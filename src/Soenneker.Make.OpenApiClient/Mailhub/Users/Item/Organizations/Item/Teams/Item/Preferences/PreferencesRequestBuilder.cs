...
using System;
namespace Soenneker.Make.OpenApiClient.Mailhub.Users.Item.Organizations.Item.Teams.Item.Preferences
{
    /// <summary>
    /// Builds and executes requests for operations under \mailhub\users\{userId}\organizations\{organizationId}\teams\{teamId}\preferences
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class PreferencesRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Make.OpenApiClient.Mailhub.Users.Item.Organizations.Item.Teams.Item.Preferences.PreferencesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PreferencesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/mailhub/users/{userId}/organizations/{organizationId}/teams/{teamId}/preferences", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Make.OpenApiClient.Mailhub.Users.Item.Organizations.Item.Teams.Item.Preferences.PreferencesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PreferencesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/mailhub/users/{userId}/organizations/{organizationId}/teams/{teamId}/preferences", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Make.OpenApiClient.Mailhub.Users.Item.Organizations.Item.Teams.Item.Preferences.PreferencesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Make.OpenApiClient.Mailhub.Users.Item.Organizations.Item.Teams.Item.Preferences.PreferencesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Make.OpenApiClient.Mailhub.Users.Item.Organizations.Item.Teams.Item.Preferences.PreferencesRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
