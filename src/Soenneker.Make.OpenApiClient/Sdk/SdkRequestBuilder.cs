...
using Soenneker.Make.OpenApiClient.Sdk.Github;
using Soenneker.Make.OpenApiClient.Sdk.Publisher;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System;
namespace Soenneker.Make.OpenApiClient.Sdk
{
    /// <summary>
    /// Builds and executes requests for operations under \sdk
    /// </summary>
    ...
    public partial class SdkRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Make.OpenApiClient.Sdk.Github.GithubRequestBuilder Github
        {
            get => new global::Soenneker.Make.OpenApiClient.Sdk.Github.GithubRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public SdkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sdk", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Make.OpenApiClient.Sdk.SdkRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SdkRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sdk", rawUrl)
        {
        }
    }
}
